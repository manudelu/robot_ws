    ...
    : Node(name) 
{
    ...
    vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("/robot_controller/cmd_vel", 10, std::bind(&Controller::velCallback, this, _1));
...
void Controller::velCallback(const geometry_msgs::msg::TwistStamped& msg) {
